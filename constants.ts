...
// A list of public CORS proxies to try when fetching feeds.
// These are public services and their availability is not guaranteed.
...
export const RSS_FEEDS: RssFeedCategory[] = [
  {
    name: 'Top-Tier Global Financial News',
    feeds: [
  ...
  {
    name: 'U.S. Regulators & Economic Data',
    feeds: [
  ...
  {
    name: 'Market Analysis & Specialty',
    feeds: [
  ...
  {
    name: 'International Markets & Global Macro',
    feeds: [
  ...
  {
    name: 'More Top-Tier News Outlets',
    feeds: [
  ...
  {
    name: 'Think Tanks & Economic Research',
    feeds: [
  ...
  {
    name: 'More U.S. Regulators & Agencies',
    feeds: [
  ...
  {
    name: 'U.S. Regional Federal Reserve Banks',
    feeds: [
  ...
  {
    name: 'International Central Banks & Regulators',
    feeds: [
  ...
  {
    name: 'Broader International News',
    feeds: [
  ...
  {
    name: 'Niche & Sector-Specific News',
    feeds: [
  ...
  {
    name: 'More Influential Blogs & Analysis',
    feeds: [
  ...
  {
    name: 'More Crypto Feeds',
    feeds: [
      { name: 'Messari', url: 'https://messari.io/rss' },
    ],
  },
  {
    name: 'Financial & Economic Podcasts',
    feeds: [
